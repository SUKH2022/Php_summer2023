...
<section class="dashboard">
    ...
    <div class="container dashboard_container">
        ...
        <aside>
            <ul>
                ...
                <?php if (isset($_SESSION['user_is_admin'])) : ?>
                    ...
                    <li><a href="manage_user.php" class="active"><i class="uil uil-users-alt"></i>
                            <h5>Manage User</h5>
                        </a>
                    </li>
                    ...
                    <li><a href="manage_category.php"><i class="uil uil-list-ul"></i>
        ...
        <main>
            ...
            <?php else : ?>
                <div class="alert_message error"><?php echo "No users found" ?></div>
            <?php endif ?>
        </main>
    </div>
</section>
